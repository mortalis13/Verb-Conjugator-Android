...
public class DatabaseManager extends SQLiteAssetHelper  {
    ...
    public DatabaseManager(Context context) {
        super(context, "verbs_fr.db", null, 1);
